...
tBinTray.content_upload(strPackage, strVersion, 'tests.muhkuh.org', 'targets/ivy/repository/org/muhkuh/tests/romcrc/SNAPSHOT/romcrc-SNAPSHOT.zip', 'romcrc.zip')
tBinTray.content_upload(strPackage, strVersion, 'tests.muhkuh.org', 'targets/ivy/repository/org/muhkuh/tests/romcrc/SNAPSHOT/ivy-SNAPSHOT.xml',    'ivy.xml')
